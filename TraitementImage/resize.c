...
void resize_image(const char *input_filename, int new_width, int new_height,int i) {
    ...
    char path[100];
    sprintf(path, "/home/xaviax/spe/OCR/DetectionLignes/Decoupage/resize/Image_%d.png", i);
    printf("%s\n", path);
...
int main() {
    ...
    for (int i = 0; i < 81; i++) {
        ...
        sprintf(input_filename, "/home/xaviax/spe/OCR/DetectionLignes/Decoupage/Image_%d.jpeg", i);
        int new_width = 28;
        int new_height = 28;
    ...
    for (int i = 0; i < 81; i++) {
        ...
        char *input_filename = malloc(100);
        sprintf(input_filename, "/home/xaviax/spe/OCR/DetectionLignes/Decoupage/resize/Image_%d.png", i);
